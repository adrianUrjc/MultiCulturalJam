...
public class TaggedDetector2D : MonoBehaviour
{
    ...
    [SerializeField, HideIf("moveWithCamera", false), Tooltip("Default is Camera.main")]
   ...
   [Space]
    ...
    [SerializeField, Tooltip("Every tag which will be detected.")]
    ...
    bool checkOnStay;
    [SerializeField]
    bool setLayerToIgnoreRayCast;
    [SerializeField]
    bool stayFixedInLocalSpace = true;
    Vector3 localPos;
    private List<GameObject> itemsInTrigger = new List<GameObject>();
